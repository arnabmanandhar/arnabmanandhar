...
## About Me
AI Engineer focusing on observability, LLM evaluation, RAG systems, agentic workflows, and ML infrastructure. I build end-to-end AI systems spanning model development, evaluation, backend engineering, and deployment.

My work centers on measuring model behavior, improving retrieval, and grounding generation in evidence. I care most about the problems that show up after the demo works: reproducibility, observability, failure analysis.
